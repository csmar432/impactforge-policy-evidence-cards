# ImpactForge delivery checklist

## Official submission fields

- [x] Project name: Policy Evidence Cards
- [x] Story behind the project
- [x] Problem and why it matters
- [x] Solution and how it works
- [x] Key features
- [x] Tools, languages, and APIs
- [x] Intended users
- [x] Impact statement
...
- [x] Source-to-action interaction
...
ImpactForge requires at least one screenshot, demo video, or file showing the project in action. The current Chromium runtime screenshots satisfy that minimum; the rest of the files below are internal handoff assets, not additional official requirements.
...
1. `impactforge-mvp-desktop.png`
2. `impactforge-mvp-desktop-page2.png`
3. `impactforge-mvp-desktop-page3.png`
4. `impactforge-mvp-mobile.png`
